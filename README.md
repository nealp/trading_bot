This program uses lumibot, an algorithmic trading bot library, to connect to the alpaca brokerage using an API key in order to send buy/sell order to a specific stock. 
